...
print("In this Class, IP address is not divided into Network and Host 
ID") 
return "D"
else: 
print("In this Class, IP address is not divided into Network and Host 
...
+ '.255') 
print("Valid range of host IP address : ", ip[0] + '.' + str(temp
- int(place2)) + '.' + '0' + '.1' + '\t-\t' + ip[0] + '.' + str( temp - 1) + 
'.254' + '.254') 
print() 
elif className == "B": 
...
'.0') 
temp += int(place2) 
print("Broadcast address : ", ".".join(ip[0:2]) + '.' + str(temp -
1) + '.255') 
print("Valid range of host IP address : ",".".join(ip[0:2]) + '.'
+ str(temp - int(place2)) + '.1\t-\t' + ".".join(ip[0:2]) + '.' + str( temp -
1) + '.254') 
print() 
elif className == "C": 
for i in range(num): 
...
print("Broadcast address : ", ".".join(ip[0:3]) + '.' + str(temp -
1)) 
print("Valid range of host IP address : ", ".".join(ip[0:3]) + '.'
+ str(temp - int(ip_addresses) + 1) + '\t-\t' + ".".join(ip[0:3]) + '.' + str( 
temp - 2)) 
print() 
else: 
print("In this Class, IP address is not divided into Network and 
Host ID") 
